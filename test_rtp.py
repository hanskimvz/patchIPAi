...
# ip = "192.168.1.28" # IP address of your cam
# adr = "rtsp://192.168.1.28:554/ufirststream" # username, passwd, etc.

ip = "192.168.132.6" # IP address of your cam
adr = "rtsp://192.168.132.6:554/channel1" # username, passwd, etc.

clientports = [56086,56087] # the client ports we are going to use for receiving video
# fname = "stream.h264" # filename for dumping the stream
fname = "ufirststream.mp4" # filename for dumping the stream
...
s.send(dest.encode('ascii'))
recst=s.recv(4096)
# print (recst)
print ("*** GOT DESCRIBE RESPONSE****")
print ()
printrec(recst)
...
print ("*** SENDING SETUP ***")
print ()
s.send(setu.encode('ascii'))
recst=s.recv(4096)
print ()
print ("*** GOT SETUP RESPONSE***")
print ()
printrec(recst)
idn=sessionid(recst)
...
s.send(play.encode('ascii'))
recst=s.recv(4096)
print ()
print ("*** GOT PLAY RESPONSE****")
print ()
printrec(recst)
print ()
print ()
