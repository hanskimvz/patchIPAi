...
adr="rtsp://192.168.132.6/channel2" # username, passwd, etc.
...
setu=("SETUP "+adr+"/trackID=v RTSP/1.0\r\nCSeq: 3\r\nUser-Agent: python\r\nTransport: RTP/AVP;unicast;client_port="+str(clientports[0])+"-"+str(clientports[1])+"\r\n\r\n").encode()
...
teardown =setsesid(teard.decode(),idn)
print(teardown.decode())
s.send(teardown)
recst=s.recv(4096)
print("*** GOT ****")
printrec(recst)
